...
private void move(float deltaTime) {
	...
	if(min(Math.abs(hitBox.x-bunny.getX()),Math.abs(hitBox.x+Gdx.graphics.getWidth()-bunny.getX()),Math.abs(Gdx.graphics.getWidth()-hitBox.x+bunny.getX()))>=min(Math.abs(hitBox.y-bunny.getY()),Math.abs(hitBox.y+Gdx.graphics.getHeight()-bunny.getY()),Math.abs(Gdx.graphics.getHeight()-hitBox.y+bunny.getY()))){
